...
RED.userSettings = (function() {
    ...
    function show(initialTab) {
        ...
        var trayOptions = {
            ...
            open: function(tray) {
                ...
                settingsTabs.activateTab("red-ui-settings-tab-"+(initialTab||'controller'))
    ...
    var controllerSettings = [
        {
            title: "menu.label.view.controller",
            options: [
                {setting:"thingjs-controller-url",label:"menu.label.view.controllerURL",type:"text",default: '', onchange:function() {}}
            ]
        }
    ];
    ...
    function createControllerPane() {

        var pane = $('<div id="red-ui-settings-tab-controller" class="red-ui-help"></div>');

        var currentEditorSettings = RED.settings.get('editor') || {};
        currentEditorSettings.view = currentEditorSettings.view || {};

        controllerSettings.forEach(function(section) {
            if (section.title) {
    ...
    function init() {
        ...
        addPane({
            id:'controller',
            title: RED._("menu.label.view.controller"),
            get: createControllerPane,
            close: function() {}
        })
