<!--
    Based on Node Red debugger node.
    Edited for ThingJS 2020
-->
<script type="text/html" data-template-name="debug" data-hardware-type="">
    <div class="form-row">
...
(function() {
    ...
    RED.nodes.registerType('debug',{
        ...
        label: function() {
            ...
            if (["flow","global"].indexOf(this.targetType) >= 0) {
                return (this.name || `${this.targetType}.${this.complete}`) + suffix;
            }
        ...
        oneditprepare: function() {
            ...
            $("#node-input-typed-complete").typedInput({
                default: "msg",
                types:['msg', "flow", "global", fullType],
                typeField: $("#node-input-targetType")
            });
            if (["flow", "global"].indexOf(this.targetType) >= 0) {
                var property = this.complete || "";
                $("#node-input-typed-complete").typedInput('type',this.targetType);
        ...
        genThingJSCode: function() {
            if (this.complete == 'true' || this.complete === true) {
                ...
                var key = JSON.stringify("" + this.complete);
