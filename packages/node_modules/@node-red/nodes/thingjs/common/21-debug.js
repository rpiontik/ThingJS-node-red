module.exports = function(RED) {
    ...
    function DebugNode(n) {
        ...
        function prepareValue(msg, done) {
            ...
            if(['flow', 'global'].indexOf(n.targetType) >= 0) {
                RED.util.evaluateNodeProperty(n.complete, n.targetType, node, msg, (err,value) => {
                    if (err) {
                        done(undefined,undefined);
                    } else {
                        done(null,{id:node.id, z:node.z, _alias: node._alias,  path:node._flow.path, name:node.name, topic:msg.topic, property:"payload", msg:value});
                    }
                });
            } else if (preparedEditExpression) {
