        ...
        genThingJSCode: function() {
            ...
            if(delay >= this._def.delay_min) {
                ...
                if(this.pauseType==="rate") {
                    ...
                    reset_q = `n.q[$i.topic]=[];${rm_from_slice}return`;
                    drop_q = `if(this.drop){n.q[$i.topic]=q=[];${rm_from_slice}}`;
                    flush_q = `if($i.flush){for(let k in n.sl)if(n.sl[k].topic===$i.topic)this.$n([n.sl[k]]);for(let k in q)this.$n([q[k]]);}`
                }
