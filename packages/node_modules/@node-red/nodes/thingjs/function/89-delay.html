        ...
        genThingJSCode: function() {
            ...
            if(delay >= this._def.delay_min) {
                ...
                if(this.pauseType==="rate") {
                    ...
                    send_q = `for(let k in n.q){if(n.q[k].length>0)c.$n([n.q[k].splice(0,1)[0]]);else delete n.q[k];}`
                           + `for(let k in n.q) return; $r.timer.clearInterval(n.tmr); $g[c._id]=null;` ;
                    ...
                    send_q = `if(n.sl.length<1)for(let k in n.q){if(n.q[k].length>0)n.sl.push(n.q[k].splice(0,1)[0]);else delete n.q[k]}`
                    ...
                    flush_q = `if($i.flush){`
                            ...
                            + `if(!$i.topic){for(let qk in n.q)for(let k in n.q[qk])this.$n([n.q[qk][k]])}`
